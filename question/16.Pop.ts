...
type Push<T extends any[], O extends any> = O extends any[] ? [...T, ...O] : [...T, O];
type Shift<T extends any[]> = T extends [infer Frist, ...infer Other] ? Other : [];
type Unshift<T extends any[], O extends any> = O extends any[] ? [...O, ...T] : [O, ...T];
...
type cases = [
  ...
  Expect<Equal<Push<[3, 2, 1], [0, -1, -2]>, [3, 2, 1, 0, -1, -2]>>,
  ...
  Expect<Equal<Unshift<[3, 2, 1], [0, -1, -2]>, [0, -1, -2, 3, 2, 1]>>,
